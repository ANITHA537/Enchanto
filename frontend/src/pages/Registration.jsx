...
function Registration() {
    ...
    return (
       <div className="w-[100vw] h-[100vh] bg-gradient-to-br from-[#ecfafa] to-white text-black flex flex-col items-center justify-start">
            ...
            {/* FORM CONTAINER */}
                ...
                <div className='max-w-[600px] w-[90%] h-[500px] bg-[#ffffff90] border border-[#00000020] backdrop-blur-2xl rounded-lg shadow-lg flex items-center justify-center'>
                    <form action="" onSubmit={handleSignup} className='w-[90%] h-[90%] flex flex-col items-center justify-strat gap-[20px]'>
                        <div className='w-[90%] h-[50px] bg-white text-black rounded-lg flex items-center justify-center gap-[10px] shadow cursor-pointer' onClick={googleSignup}>
                        ...
                        <div className='w-[90%] h-[275px] flex flex-col items-center justify-center gap-[15px] relative'>
                            <input type="text" className='w-[100%] h-[50px] border-[2px] border-[#77777750] bg-white  backdrop:blur-sm rounded-lg shadow-lg  px-[20px] font-medium' placeholder='UserName' required onChange={(e)=>setName(e.target.value)} value={name}/>
                            ...
                            {show && <FaRegEyeSlash className='w-[20px] h-[20px] cursor-pointer absolute right-[5%]'onClick={()=>setShow(prev=>!prev)}/>}
